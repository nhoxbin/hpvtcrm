    ...
    <Modal :show="isEditCustomer" @close="closeModal" max-width="xl">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="p-4 md:p-5">
          <form class="max-w-sm mx-auto" action="#" @submit.prevent="submit(customer)">
            <div class="mb-5">
            ...
            <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Thêm ghi chú</button>
          </form>
        </div>
      </div>
    </Modal>
