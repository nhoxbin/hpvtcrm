  ...
  <AuthenticatedLayout>
    ...
    <div class="p-4 bg-white rounded-lg shadow-xs">
      <div class="mb-4 w-full">
        ...
        <SecondaryButton @click="actions.isCreateUser = true"
          >Thêm thành viên</SecondaryButton
        >
      </div>
              ...
              >
                ...
                <td>
                  {{
                    ...
                    ($page.props.auth.user.id == user.id ? "(Tôi)" : "")
                  }}
                </td>
                <td class="px-4 py-3 text-sm">
    ...
    <CreateUserForm
      :is-create-user="actions.isCreateUser"
      :roles="roles"
      @closeForm="onCloseForm"
    ></CreateUserForm>
    <EditUserForm
      v-if="actions.isEditUser"
      :isEditUser="actions.isEditUser"
      :roles="roles"
      :user="currentUser"
      @closeForm="onCloseForm"
    ></EditUserForm>
...
const del = (user) => {
  ElMessageBox.confirm("Bạn có chắc muốn xóa nhân viên này chứ?", "Warning", {
