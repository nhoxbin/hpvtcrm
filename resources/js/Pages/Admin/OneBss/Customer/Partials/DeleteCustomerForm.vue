        ...
        <div class="p-4 md:p-5">
          <form class="max-w-sm mx-auto" action="#" @submit.prevent="submit">
            <div class="mb-5">
              ...
              <InputError :message="formSearch.errors.command" class="mt-2" />
            </div>
            ...
            <div class="mt-6 flex justify-end">
              ...
              <DangerButton
                class="ms-3"
                :class="{ 'opacity-25': formSearch.processing }"
...
const del = () => {
  props.formSearch.delete(route("admin.onebss.customers.destroy"), {
    preserveScroll: true,
