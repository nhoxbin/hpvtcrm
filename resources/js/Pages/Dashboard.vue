...
const regisMethods = ref([{method: 'otp', checked: true}]);
                    ...
                    <!-- <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg"> -->
                        <section class="max-w-4xl lg:px-4">
                            <div class="grid grid-cols-2 md:grid-cols-3">
                                <div class="max-w-sm p-2 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-2" v-for="product in products.data" :key="product.id">
                                    <button @click="onClickData(product)">
                                ...
                                <div class="max-w-sm p-2 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-2" v-for="product in workingProducts" :key="product.id">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex justify-center">
                                            <div class="mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]" v-for="method in regisMethods" :key="method.method">
                                                <input
                                                ...
                                                <label class="mt-px inline-block pl-[0.15rem] hover:cursor-pointer" for="inlineRadio1">{{ method.method }}</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div>Nhập mã OTP để hoàn tất đăng ký</div>
