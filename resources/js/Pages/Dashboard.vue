                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <section class="max-w-4xl sm:px-2 lg:px-3">
                            <div class="grid grid-cols-1 md:grid-cols-2">
                                ...
                                <div :class="{'pointer-events-none': sendingRegis[product.id]}" class="relative items-center block max-w-sm p-2 bg-white border border-gray-100 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-2" v-for="(product, index) in workingData" :key="product.id">
                                    ...
                                    <div v-if="sendingRegis[product.id]" role="status" class="absolute -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2">
